 ...
 public function detail($id_bencana)
    {
          ...
          $mpdf = new \Mpdf\Mpdf([
            ...
            $q_bencana = $this->db->query("SELECT jb.nama_bencana, b.lokasi, b.tgl_kejadian from bencana b left join jenis_bencana jb on b.id_jenis_bencana = jb.id_jenis_bencana where id_bencana = '$id_bencana'");
